# E9T4 — Handle Run Round Now Button Callback

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

When the group creator clicks the 'Run Round Now' button, the bot should immediately start the round, bypassing the 30-second countdown. The countdown and elimination process should proceed as normal.
