# E3T1 — GIF Countdown Messages

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Send three sequential messages with GIFs for 3, 2, 1 countdown. Use group's configured gif_pack URLs. Add 1s delay between messages.
