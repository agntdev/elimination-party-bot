# E4T2 — Stake Distribution Math

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Calculate floor(stake/(n-1)) for survivors. Distribute remainder +1 points in join order. Update balances and create transaction records.
