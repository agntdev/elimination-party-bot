# E5T1 — Database Schema Implementation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Create tables for groups, players, rounds, and transactions with fields matching the spec. Add indexes on group_id, user_id, and state fields.
