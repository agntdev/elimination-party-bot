# E9T3 — Handle Join Button Callbacks

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

When a user clicks the 'Join' button, the bot should respond with an answerCallback and record the user as having joined the current open round. The user should be added to the join list if they have sufficient balance.
