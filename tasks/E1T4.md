# E1T4 — /balance Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Implement /balance command to show user's current balance and round participation status. Format: 'Balance: X points | In current round: Yes/No'.
