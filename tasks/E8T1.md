# E8T1 — Update database schema to use usernames

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Modify Groups, Players, Rounds, and Transactions tables to replace user_id with username fields. Update primary keys and foreign keys accordingly.

## Skills

**Skills:** telegram-bot-basics, database-schema-design
