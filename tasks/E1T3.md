# E1T3 — Start Now Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Add 'Start Now' inline button (callback_data: start:round) visible only to group creator. Force round start if ≥2 players joined.

## Skills

**Skills:** telegram-bot-basics, telegram-bot-ui, telegram-bot-ux
