# E9T1 — Support Inline Queries for Starting Game

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Implement inline query handling for the command @bot start. When a user types this, the bot should respond with a suggestion to start a game in the current group chat. The suggestion should trigger the bot to publish a message with game details and buttons.

## Skills

**Skills:** telegram-bot-basics, inline-queries
