# E6T1 — Insufficient Balance Handling

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Reject /join if user.balance < group.stake. Show /balance button in response. Format: 'Not enough points! Current balance: X'.

## Skills

**Skills:** telegram-bot-basics, telegram-bot-ux
