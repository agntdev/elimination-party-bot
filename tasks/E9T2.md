# E9T2 — Publish Game Start Message with Buttons

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

When a user selects the inline suggestion to start a game, the bot should publish a message in the group chat with the number of participants, the current stake, and two buttons: 'Join' and 'Run Round Now'. The 'Run Round Now' button should only be visible to the group creator.

## Skills

**Skills:** telegram-bot-basics, callback-buttons
