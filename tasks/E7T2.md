# E7T2 — Concurrent Round Test

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Write test for concurrent /startround commands from multiple users. Verify only one round is created and started.

## Skills

**Skills:** telegram-test-specs
