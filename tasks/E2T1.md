# E2T1 — Round Auto-Creation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Automatically create a new open round when ≥2 players join. Start 30s join window. Store group_id, stake, state, and join_list in session storage.
