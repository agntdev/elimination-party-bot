# E1T1 — Join Round Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Add 'Join' inline button to main menu (callback_data: join:round). Verify user balance >= group stake before adding to join_list. Show error if insufficient balance.
