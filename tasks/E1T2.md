# E1T2 — Leave Round Button

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 ELIM

Add 'Leave' inline button to main menu (callback_data: leave:round). Remove user from current open round's join_list if not started. Show confirmation message.
